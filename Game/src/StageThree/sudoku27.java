...
public class sudoku27 extends JFrame {
	...
	public sudoku27() {
		...
		s1lev2.setBackground(Classes.lightGray);
	...
	private void s3lev7(ActionEvent evt) {
		String alert = " Level 7 Stage Three";
	Classes.ALERT(alert);
	}
	...
	private void next(ActionEvent evt) {
		dispose();
		sudoku28 s3 = new sudoku28();
		s3.setVisible(true);
	}
	
	private void pre(ActionEvent evt){
		dispose();
		sudoku26 s1 = new sudoku26();
		s1.setVisible(true);
	}
