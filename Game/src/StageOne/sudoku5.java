...
public class sudoku5 extends JFrame{
	...
	JTextField At1, At3, At4, At8,
	 ...
	 JLabel Al2, Al5, Al6, Al7, Al9, Bl8, Cl2, Cl4, Cl5, Cl7, Cl9,
	...
	public sudoku5() {
		...
		panelA = new JPanel();
		panelA.setBackground(new java.awt.Color(204, 255, 204));
		panelA.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 255), 1, true));
		panelA.setLayout(new GridLayout(3, 3));
		At1 = new JTextField();
		Al2 = new JLabel("  1");
		At3 = new JTextField();
		At4 = new JTextField();
		...
		panelB = new JPanel();
		panelB.setBackground(new java.awt.Color(204, 255, 204));
		panelB.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 255), 1, true));
		panelB.setLayout(new GridLayout(3, 3));
		Bt1 = new JTextField();
		Bt2 = new JTextField();
		Bt3 = new JTextField();
		Bt4 = new JTextField();
		...
		panelC.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 255), 1, true));
		...
		panelD = new JPanel();
		panelD.setBackground(new java.awt.Color(204, 255, 204));
		panelD.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 255), 1, true));
		...
		panelE = new JPanel();
		panelE.setBackground(new java.awt.Color(204, 255, 204));
		panelE.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 255), 1, true));
		panelE.setLayout(new GridLayout(3, 3));
		El1 = new JLabel("  7");
		Et2 = new JTextField();
		Et3 = new JTextField();
		El4 = new JLabel("  3");
		...
		panelF = new JPanel();
		panelF.setBackground(new java.awt.Color(204, 255, 204));
		panelF.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 255), 1, true));
		panelF.setLayout(new GridLayout(3, 3));
		Fl1 = new JLabel("  3");
		Fl2 = new JLabel("  9");
		Fl3 = new JLabel("  5");
		Fl4 = new JLabel("  6");
		...
		panelG.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 255), 1, true));
		...
		panelH = new JPanel();
		panelH.setBackground(new java.awt.Color(204, 255, 204));
		panelH.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 255), 1, true));
		panelH.setLayout(new GridLayout(3, 3));
		Ht1 = new JTextField();
		Ht2 = new JTextField();
		Ht3 = new JTextField();
		Ht4 = new JTextField();
		...
		panelI = new JPanel();
		panelI.setBackground(new java.awt.Color(204, 255, 204));
		panelI.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 255), 1, true));
		panelI.setLayout(new GridLayout(3, 3));
		Il1 = new JLabel("  9");
		It2 = new JTextField();
		It3 = new JTextField();
		Il4 = new JLabel("  1");
...
dispose();
	...
	private void s1lev4(ActionEvent evt) {
		...
		sudoku4 s4 = new sudoku4();
		s4.setVisible(true);
	}

	private void s1lev5(ActionEvent evt) {
		String alert = "Leve 5 Stage One";
		Classes.ALERT(alert);
