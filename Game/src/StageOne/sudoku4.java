...
public class sudoku4 extends JFrame{
	...
	public sudoku4(){
		...
		panelB = new JPanel();
		panelB.setBackground(new java.awt.Color(184, 234, 180));
		...
		panelC = new JPanel();
		panelC.setBackground(new java.awt.Color(195, 244, 190));
		...
		panelD = new JPanel();
		panelD.setBackground(new java.awt.Color(175, 224, 170));
		...
		panelE = new JPanel();
		panelE.setBackground(new java.awt.Color(155, 204, 150));
		...
		panelF = new JPanel();
		panelF.setBackground(new java.awt.Color(105, 154, 100));
		...
		panelG = new JPanel();
		panelG.setBackground(new java.awt.Color(135, 184, 130));
		...
		panelH = new JPanel();
		panelH.setBackground(new java.awt.Color(125, 174, 120));
		...
		panelI = new JPanel();
		panelI.setBackground(new java.awt.Color(115, 164, 110));
	...
	private void s1lev4(ActionEvent evt) {
		String alert = " Level 4 Stage One";
	Classes.ALERT(alert);
	}
